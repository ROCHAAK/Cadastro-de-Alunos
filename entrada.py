...
def ler_string(msg=""):
    """
    Realiza a leitura de um valor string, tratando possíveis erros

    Parâmetros:
      - msg: Mensagem a ser exibida antes da leitura. Por padrão "" (vazia)

    Retorno:
     - Valor string lido do teclado
    """
    while True:
        valor = input(msg)
        if valor != "":  
            ...
            print("Entrada de dados em formato inválido! O campo não pode está VAZIO. Digite novamente:")
